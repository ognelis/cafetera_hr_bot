...
class TestVacationContent:
    def test_template_contains_entity(self):
        entity = ENTITIES[3]
        text = str(vacation_template_text(entity))
        assert entity.full_name in text
