...
ERR_DOCUMENT_UNAVAILABLE = (
    ...
    "Попробуйте повторить запрос позже или обратитесь в HR-отдел."
)

ERR_NO_ANSWER = (
    "🔍 К сожалению, точного ответа в базе знаний не найдено.\n\n"
    "Рекомендуем обратиться в HR-отдел для уточнения."
)
